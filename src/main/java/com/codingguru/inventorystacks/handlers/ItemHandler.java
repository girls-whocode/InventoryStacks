...
public class ItemHandler {
	...
	private boolean setupServerVersion() {
		...
		if (versionFound.equalsIgnoreCase("craftbukkit")) {
			return fallbackBySemver(major, minor);
		}
	...
	private boolean fallbackBySemver(int major, int minor) {
	...
	/**
	 * Legacy shim for older listeners/classes still present in source.
	 */
	@Deprecated
