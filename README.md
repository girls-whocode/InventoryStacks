...
- Plugin version: `2.7.0-MC26-BETA`
...
- Folia-aware scheduling support.
...
This build is intentionally marked BETA while runtime validation is completed. All tests at this point have
passed, please see the `UPLIFT_26_1_2_RUNTIME_CHECKLIST.md` for completed tests. Use the checklist in 
`UPLIFT_26_1_2_RUNTIME_CHECKLIST.md` before production rollout.
